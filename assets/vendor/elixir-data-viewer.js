...
class P {
  ...
  */
  constructor(O = {}) {
    this.id = lt++, this.perNode = !!O.perNode, this.deserialize = O.deserialize || (() => {
  ...
  */
  add(O) {
    ...
    return typeof O != "function" && (O = I.match(O)), (e) => {
      let t = O(e);
      return t === void 0 ? null : [this, t];
    };
  }
}
P.closedBy = new P({ deserialize: (i) => i.split(" ") });
P.openedBy = new P({ deserialize: (i) => i.split(" ") });
P.group = new P({ deserialize: (i) => i.split(" ") });
P.isolate = new P({ deserialize: (i) => {
...
class bO {
  constructor(O, e, t, r = !1) {
    this.tree = O, this.overlay = e, this.parser = t, this.bracketed = r;
  }
  /**
  @internal
  */
  static get(O) {
    return O && O.props && O.props[P.mounted.id];
  }
}
...
class I {
  ...
  */
  static define(O) {
    let e = O.props && O.props.length ? /* @__PURE__ */ Object.create(null) : ht, t = (O.top ? 1 : 0) | (O.skipped ? 2 : 0) | (O.error ? 4 : 0) | (O.name == null ? 8 : 0), r = new I(O.name || "", e, O.id, t);
    if (O.props) {
  ...
  static match(O) {
    ...
    for (let t in O)
      for (let r of t.split(" "))
        e[r] = O[t];
    return (t) => {
      for (let r = t.prop(P.group), n = -1; n < (r ? r.length : 0); n++) {
        let a = e[n < 0 ? t.name : r[n]];
        if (a)
          return a;
      }
    };
  ...
  */
  extend(...O) {
    ...
    for (let t of this.types) {
      ...
      e.push(r ? new I(t.name, r, t.id, t.flags) : t);
    }
    return new oe(e);
  }
}
const YO = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap();
var Y;
(function(i) {
...
class Z {
  ...
  */
  constructor(O, e, t, r, n) {
    if (this.type = O, this.children = e, this.positions = t, this.length = r, this.props = null, n && n.length) {
  ...
  */
  cursorAt(O, e = 0, t = 0) {
    let r = YO.get(this) || this.topNode, n = new Oe(r);
    return n.moveTo(O, e), YO.set(this, n._tree), n;
  }
  /**
  ...
  */
  resolve(O, e = 0) {
    let t = qO(YO.get(this) || this.topNode, O, e, !1);
    return YO.set(this, t), t;
  }
  /**
  ...
  */
  resolveInner(O, e = 0) {
    let t = qO($e.get(this) || this.topNode, O, e, !0);
  ...
  */
  iterate(O) {
    let { enter: e, leave: t, from: r = 0, to: n = this.length } = O, a = O.mode || 0, s = (a & Y.IncludeAnonymous) > 0;
    for (let o = this.cursor(a | Y.IncludeAnonymous); ; ) {
      let X = !1;
      if (o.from <= n && o.to >= r && (!s && o.type.isAnonymous || e(o) !== !1)) {
        if (o.firstChild())
          continue;
        X = !0;
      }
      for (; X && t && (s || !o.type.isAnonymous) && t(o), !o.nextSibling(); ) {
        if (!o.parent())
          return;
        X = !0;
      }
  ...
  */
  balance(O = {}) {
    return this.children.length <= 8 ? this : Xe(I.none, this.children, this.positions, 0, this.children.length, 0, this.length, (e, t, r) => new Z(this.type, e, t, r, this.propValues), O.makeTree || ((e, t, r) => new Z(I.none, e, t, r)));
  }
  /**
...
class le {
  ...
  fork() {
    return new le(this.buffer, this.index);
  }
}
class lO {
  /**
  ...
  */
  childString(O) {
    let e = this.buffer[O], t = this.buffer[O + 3], r = this.set.types[e], n = r.name;
    if (/\W/.test(n) && !r.isError && (n = JSON.stringify(n)), O += 4, t == O)
      return n;
    let a = [];
    for (; O < t; )
  ...
  */
  findChild(O, e, t, r, n) {
    ...
    for (let o = O; o != e && !(Ge(n, r, a[o + 1], a[o + 2]) && (s = o, t > 0)); o = a[o + 3])
      ;
    return s;
  }
  /**
  ...
  */
  slice(O, e, t) {
    let r = this.buffer, n = new Uint16Array(e - O), a = 0;
    for (let s = O, o = 0; s < e; ) {
      n[o++] = r[s++], n[o++] = r[s++] - t;
      let X = n[o++] = r[s++] - t;
      n[o++] = r[s++] - O, a = Math.max(a, X);
    }
    return new lO(n, a, this.set);
  }
}
function Ge(i, O, e, t) {
  switch (i) {
...
function qO(i, O, e, t) {
  for (var r; i.from == i.to || (e < 1 ? i.from >= O : i.from > O) || (e > -1 ? i.to <= O : i.to < O); ) {
    let a = !t && i instanceof L && i.index < 0 ? null : i.parent;
    if (!a)
      return i;
    i = a;
  }
  let n = t ? 0 : Y.IgnoreOverlays;
  if (t)
    for (let a = i, s = a.parent; s; a = s, s = a.parent)
      a instanceof L && a.index < 0 && ((r = s.enter(O, e, n)) === null || r === void 0 ? void 0 : r.from) != a.from && (i = s);
  for (; ; ) {
    let a = i.enter(O, e, n);
    if (!a)
      return i;
...
class Ee {
  ...
  getChildren(O, e = null, t = null) {
    return de(this, O, e, t);
  }
  resolve(O, e = 0) {
    return qO(this, O, e, !1);
  }
  resolveInner(O, e = 0) {
    return qO(this, O, e, !0);
  }
  matchContext(O) {
    return JO(this.parent, O);
  }
  enterUnfinishedNodesBefore(O) {
    ...
    for (; e; ) {
      ...
      if (!r || r.to != e.to)
        break;
      r.type.isError && r.from == r.to ? (t = e, e = r.prevSibling) : e = r;
    }
    return t;
  }
  get node() {
...
class L extends Ee {
  constructor(O, e, t, r) {
    super(), this._tree = O, this.from = e, this.index = t, this._parent = r;
  }
  get type() {
  ...
  nextChild(O, e, t, r, n = 0) {
    for (let a = this; ; ) {
      for (let { children: s, positions: o } = a._tree, X = e > 0 ? s.length : -1; O != X; O += e) {
        let c = s[O], l = o[O] + a.from, Q;
        if (!(!(n & Y.EnterBracketed && c instanceof Z && (Q = bO.get(c)) && !Q.overlay && Q.bracketed && t >= l && t <= l + c.length) && !Ge(r, t, l, l + c.length))) {
          if (c instanceof lO) {
            if (n & Y.ExcludeBuffers)
              continue;
            let f = c.findChild(0, c.buffer.length, e, t - l, r);
            if (f > -1)
              return new aO(new Xt(a, c, O, l), null, f);
          } else if (n & Y.IncludeAnonymous || !c.type.isAnonymous || he(c)) {
            let f;
            if (!(n & Y.IgnoreMounts) && (f = bO.get(c)) && !f.overlay)
              return new L(f.tree, l, O, a);
            let g = new L(c, l, O, a);
            return n & Y.IncludeAnonymous || !g.type.isAnonymous ? g : g.nextChild(e < 0 ? c.children.length - 1 : 0, e, t, r, n);
          }
        }
      }
      if (n & Y.IncludeAnonymous || !a.type.isAnonymous || (a.index >= 0 ? O = a.index + e : O = e < 0 ? -1 : a._parent._tree.children.length, a = a._parent, !a))
        return null;
    }
  }
  get firstChild() {
  ...
  enter(O, e, t = 0) {
    let r;
    if (!(t & Y.IgnoreOverlays) && (r = bO.get(this._tree)) && r.overlay) {
      let n = O - this.from, a = t & Y.EnterBracketed && r.bracketed;
      for (let { from: s, to: o } of r.overlay)
        if ((e > 0 || a ? s <= n : s < n) && (e < 0 || a ? o >= n : o > n))
          return new L(r.tree, r.overlay[0].from + this.from, -1, this);
    }
...
function de(i, O, e, t) {
  ...
  for (; ; ) {
    if (t != null && r.type.is(t))
      return n;
    if (r.type.is(O) && n.push(r.node), !r.nextSibling())
      return t == null ? n : [];
  }
}
function JO(i, O, e = O.length - 1) {
  for (let t = i; e >= 0; t = t.parent) {
    if (!t)
      return !1;
...
class Xt {
  constructor(O, e, t, r) {
    this.parent = O, this.buffer = e, this.index = t, this.start = r;
  }
}
class aO extends Ee {
  get name() {
  ...
  child(O, e, t) {
    let { buffer: r } = this.context, n = r.findChild(this.index + 4, r.buffer[this.index + 3], O, e - this.context.start, t);
  ...
  enter(O, e, t = 0) {
    if (t & Y.ExcludeBuffers)
      return null;
    let { buffer: r } = this.context, n = r.findChild(this.index + 4, r.buffer[this.index + 3], e > 0 ? 1 : -1, O - this.context.start, e);
    return n < 0 ? null : new aO(this.context, this, n);
  }
  get parent() {
  ...
  toTree() {
    let O = [], e = [], { buffer: t } = this.context, r = this.index + 4, n = t.buffer[this.index + 3];
    if (n > r) {
      let a = t.buffer[this.index + 1];
      O.push(t.slice(r, n, a)), e.push(0);
    }
...
function Le(i) {
  ...
  let t = e instanceof L && e.index < 0 ? null : e.parent, r = i.slice();
  return t ? r[O] = t : r.splice(O, 1), new ut(r, e);
}
class ut {
  constructor(O, e) {
  ...
  get next() {
    return Le(this.heads);
  }
}
function ct(i, O, e) {
  let t = i.resolveInner(O, e), r = null;
  for (let n = t instanceof L ? t : t.context.parent; n; n = n.parent)
    if (n.index < 0) {
      let a = n.parent;
      (r || (r = [t])).push(a.resolve(O, e)), n = a;
    } else {
      let a = bO.get(n.tree);
      if (a && a.overlay && a.overlay[0].from <= O && a.overlay[a.overlay.length - 1].to >= O) {
        let s = new L(a.tree, a.overlay[0].from + n.from, -1, n);
        (r || (r = [t])).push(qO(s, O, e, !1));
      }
    }
  return r ? Le(r) : t;
}
class Oe {
  ...
  */
  constructor(O, e = 0) {
    if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = e & ~Y.EnterBracketed, O instanceof L)
      this.yieldNode(O);
    else {
  ...
  yieldBuf(O, e) {
    ...
    return this.type = e || r.set.types[r.buffer[O]], this.from = t + r.buffer[O + 1], this.to = t + r.buffer[O + 2], !0;
  }
  /**
  @internal
  */
  yield(O) {
    return O ? O instanceof L ? (this.buffer = null, this.yieldNode(O)) : (this.buffer = O.context, this.yieldBuf(O.index, O.type)) : !1;
  }
  /**
  @internal
  */
  ...
  */
  enterChild(O, e, t) {
    ...
    let { buffer: r } = this.buffer, n = r.findChild(this.index + 4, r.buffer[this.index + 3], O, e - this.buffer.start, t);
  ...
  */
  enter(O, e, t = this.mode) {
    return this.buffer ? t & Y.ExcludeBuffers ? !1 : this.enterChild(1, O, e) : this.yield(this._tree.enter(O, e, t));
  }
  /**
  ...
  */
  sibling(O) {
    ...
    if (O < 0) {
      ...
      if (r < (t < 0 ? e.buffer.length : e.buffer[this.stack[t] + 3]))
    ...
    for (; t; { index: e, _parent: t } = t)
      if (e > -1)
        for (let n = e + O, a = O < 0 ? -1 : t._tree.children.length; n != a; n += O) {
          ...
          if (this.mode & Y.IncludeAnonymous || s instanceof lO || !s.type.isAnonymous || he(s))
            return !1;
        }
    return !0;
  }
  ...
  */
  get node() {
    ...
    if (O && O.context == this.buffer)
      O: for (let r = this.index, n = this.stack.length; n >= 0; ) {
    ...
    for (let r = t; r < this.stack.length; r++)
      e = new aO(this.buffer, e, this.stack[r]);
  ...
  */
  iterate(O, e) {
    for (let t = 0; ; ) {
      ...
      for (; ; ) {
        if (r && e && e(this), r = this.type.isAnonymous, !t)
          return;
        if (this.nextSibling())
          break;
        this.parent(), t--, r = !0;
  ...
  */
  matchContext(O) {
    if (!this.buffer)
      return JO(this.node.parent, O);
    let { buffer: e } = this.buffer, { types: t } = e.set;
    for (let r = O.length - 1, n = this.stack.length - 1; r >= 0; n--) {
      if (n < 0)
        return JO(this._tree, O, r);
...
function he(i) {
  return i.children.some((O) => O instanceof lO || !O.type.isAnonymous || he(O));
}
function Qt(i) {
  var O;
  let { buffer: e, nodeSet: t, maxBufferLength: r = 1024, reused: n = [], minRepeatType: a = t.types.length } = i, s = Array.isArray(e) ? new le(e, e.length) : e, o = t.types, X = 0, c = 0;
  function l(S, q, p, W, v, _) {
    let { id: m, start: $, end: b, size: y } = s, U = c, eO = X;
    if (y < 0)
      if (s.next(), y == -1) {
        let K = n[m];
        p.push(K), W.push($ - S);
    ...
    let mO = o[m], WO, hO, pe = $ - S;
    if (b - $ <= r && (hO = j(s.pos - q, v))) {
      let K = new Uint16Array(hO.size - hO.skip), G = s.pos - hO.size, F = K.length;
      for (; s.pos > G; )
        F = w(hO.start, K, F);
      WO = new lO(K, b - hO.start, t), pe = hO.start - S;
    } else {
      let K = s.pos - y;
      s.next();
      let G = [], F = [], XO = m >= a ? m : -1, pO = 0, _O = b;
      for (; s.pos > K; )
        XO >= 0 && s.id == XO && s.size >= 0 ? (s.end <= _O - r && (g(G, F, $, pO, s.end, _O, XO, U, eO), pO = G.length, _O = s.end), s.next()) : _ > 2500 ? Q($, K, G, F) : l($, K, G, F, XO, _ + 1);
      if (XO >= 0 && pO > 0 && pO < G.length && g(G, F, $, pO, $, _O, XO, U, eO), G.reverse(), F.reverse(), XO > -1 && pO > 0) {
        let ge = f(mO, eO);
        WO = Xe(mO, G, F, 0, G.length, 0, b - $, ge, ge);
      } else
        WO = x(mO, G, F, b - $, U - b, eO);
    }
    p.push(WO), W.push(pe);
  }
  function Q(S, q, p, W) {
    let v = [], _ = 0, m = -1;
    for (; s.pos > q; ) {
      let { id: $, start: b, end: y, size: U } = s;
      if (U > 4)
        s.next();
      else {
        if (m > -1 && b < m)
          break;
        m < 0 && (m = y - r), v.push($, b, y), _++, s.next();
      }
    }
    if (_) {
      let $ = new Uint16Array(_ * 4), b = v[v.length - 2];
      for (let y = v.length - 3, U = 0; y >= 0; y -= 3)
        $[U++] = v[y], $[U++] = v[y + 1] - b, $[U++] = v[y + 2] - b, $[U++] = U;
      p.push(new lO($, v[2] - b, t)), W.push(b - S);
    }
  }
  function f(S, q) {
    return (p, W, v) => {
      let _ = 0, m = p.length - 1, $, b;
      if (m >= 0 && ($ = p[m]) instanceof Z) {
        if (!m && $.type == S && $.length == v)
          return $;
        (b = $.prop(P.lookAhead)) && (_ = W[m] + $.length + b);
      }
      return x(S, p, W, v, _, q);
    };
  }
  function g(S, q, p, W, v, _, m, $, b) {
    let y = [], U = [];
    for (; S.length > W; )
      y.push(S.pop()), U.push(q.pop() + p - v);
    S.push(x(t.types[m], y, U, _ - v, $ - _, b)), q.push(v - p);
  }
  function x(S, q, p, W, v, _, m) {
    if (_) {
      let $ = [P.contextHash, _];
      m = m ? [$].concat(m) : [$];
    }
    ...
    return new Z(S, q, p, W, m);
  }
  function j(S, q) {
    let p = s.fork(), W = 0, v = 0, _ = 0, m = p.end - r, $ = { size: 0, start: 0, skip: 0 };
    O: for (let b = p.pos - S; p.pos > b; ) {
      let y = p.size;
      if (p.id == q && y >= 0) {
        $.size = W, $.start = v, $.skip = _, _ += 4, W += 4, p.next();
        continue;
      }
      let U = p.pos - y;
      if (y < 0 || U < b || p.start < m)
        break;
      let eO = p.id >= a ? 4 : 0, mO = p.start;
      for (p.next(); p.pos > U; ) {
        if (p.size < 0)
    ...
    return (q < 0 || W == S) && ($.size = W, $.start = v, $.skip = _), $.size > 4 ? $ : void 0;
  }
  function w(S, q, p) {
    let { id: W, start: v, end: _, size: m } = s;
    if (s.next(), m >= 0 && W < a) {
      let $ = p;
      if (m > 4) {
        let b = s.pos - (m - 4);
      ...
      q[--p] = $, q[--p] = _ - S, q[--p] = v - S, q[--p] = W;
    } else m == -3 ? X = W : m == -4 && (c = W);
    return p;
  }
  let V = [], T = [];
  for (; s.pos > 0; )
    l(i.start || 0, i.bufferStart || 0, V, T, -1, 0);
  let N = (O = i.length) !== null && O !== void 0 ? O : V.length ? T[0] + V[0].length : 0;
  return new Z(o[i.topID], V.reverse(), T.reverse(), N);
}
const xe = /* @__PURE__ */ new WeakMap();
function RO(i, O) {
  if (!i.isAnonymous || O instanceof lO || O.type != i)
    return 1;
  let e = xe.get(O);
  if (e == null) {
    e = 1;
    for (let t of O.children) {
      if (t.type != i || !(t instanceof Z)) {
        e = 1;
        break;
      }
      e += RO(i, t);
...
function Xe(i, O, e, t, r, n, a, s, o) {
  ...
  function f(g, x, j, w, V) {
    for (let T = j; T < w; ) {
      let N = T, S = x[T], q = RO(i, g[T]);
      for (T++; T < w; T++) {
        let p = RO(i, g[T]);
        if (q + p >= c)
          break;
      ...
      if (T == N + 1) {
        if (q > c) {
          let p = g[N];
          f(p.children, p.positions, 0, p.children.length, x[N] + V);
          continue;
        }
        l.push(g[N]);
      } else {
        let p = x[T - 1] + g[T - 1].length - S;
        l.push(Xe(i, g, x, N, T, S, p, null, o));
      }
      Q.push(S + V - n);
    }
  }
  return f(O, e, t, r, 0), (s || o)(l, Q, a);
}
class ft {
  /**
  ...
  */
  startParse(O, e, t) {
    return typeof O == "string" && (O = new pt(O)), t = t ? t.length ? t.map((r) => new BO(r.from, r.to)) : [new BO(0, 0)] : [new BO(0, O.length)], this.createParse(O, e || [], t);
  }
  /**
...
class EO {
  ...
  @internal
  */
  constructor(O, e, t, r, n, a, s, o, X, c = 0, l) {
    this.p = O, this.stack = e, this.state = t, this.reducePos = r, this.pos = n, this.score = a, this.buffer = s, this.bufferBase = o, this.curContext = X, this.lookAhead = c, this.parent = l;
  }
  /**
  @internal
  */
  ...
  */
  static start(O, e, t = 0) {
    ...
    return new EO(O, [], e, t, t, 0, [], 0, r ? new me(r, r.start) : null, 0, null);
  }
  /**
  ...
  */
  reduce(O) {
    var e;
    let t = O >> 19, r = O & 65535, { parser: n } = this.p, a = this.reducePos < this.pos - 25 && this.setLookAhead(this.pos), s = n.dynamicPrecedence(r);
    ...
    let o = this.stack.length - (t - 1) * 3 - (O & 262144 ? 6 : 0), X = o ? this.stack[o - 2] : this.p.ranges[0].from, c = this.reducePos - X;
    c >= 2e3 && !(!((e = this.p.parser.nodeSet.types[r]) === null || e === void 0) && e.isAnonymous) && (X == this.p.lastBigReductionStart ? (this.p.bigReductionCount++, this.p.lastBigReductionSize = c) : this.p.lastBigReductionSize < c && (this.p.bigReductionCount = 1, this.p.lastBigReductionStart = X, this.p.lastBigReductionSize = c));
    let l = o ? this.stack[o - 1] : 0, Q = this.bufferBase + this.buffer.length - l;
    if (r < n.minRepeatTerm || O & 131072) {
      let f = n.stateFlag(
        this.state,
        1
        /* StateFlag.Skipped */
      ) ? this.pos : this.reducePos;
      this.storeNode(r, X, f, Q + 4, !0);
    }
    if (O & 262144)
      this.state = this.stack[o];
    else {
      let f = this.stack[o - 3];
      this.state = n.getGoto(f, r, !0);
    }
    for (; this.stack.length > o; )
      this.stack.pop();
    this.reduceContext(r, X);
  }
  // Shift a value into the buffer
  /**
  @internal
  */
  storeNode(O, e, t, r = 4, n = !1) {
    ...
    if (!n || this.pos == t)
      ...
      this.buffer[a] = O, this.buffer[a + 1] = e, this.buffer[a + 2] = t, this.buffer[a + 3] = r;
    }
  }
  ...
  */
  shift(O, e, t, r) {
    if (O & 131072)
      ...
      this.pos = r, this.shiftContext(e, t), e <= this.p.parser.maxNode && this.buffer.push(e, t, r, 4);
    else {
      ...
      !s && (r > t || e <= a.maxNode) && (this.reducePos = r), this.pushState(n, s ? t : Math.min(t, this.reducePos)), this.shiftContext(e, t), e <= a.maxNode && this.buffer.push(e, t, r, 4);
    }
  }
  // Apply an action
  /**
  ...
  */
  apply(O, e, t, r) {
    O & 65536 ? this.reduce(O) : this.shift(O, e, t, r);
  }
  ...
  */
  useNode(O, e) {
    ...
    let r = this.pos;
    this.reducePos = this.pos = r + O.length, this.pushState(e, r), this.buffer.push(
      t,
      r,
      this.reducePos,
      -1
  ...
  */
  split() {
    ...
    for (; e > 0 && O.buffer[e - 2] > O.reducePos; )
      e -= 4;
    let t = O.buffer.slice(e), r = O.bufferBase + e;
    for (; O && r == O.bufferBase; )
      O = O.parent;
    return new EO(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, t, r, this.curContext, this.lookAhead, O);
  }
  ...
  recoverByInsert(O) {
    ...
    if (e.length > 8 || this.stack.length >= 120) {
      ...
      for (let n = 0, a; n < e.length; n += 2)
        (a = e[n + 1]) != this.state && this.p.parser.hasAction(a, O) && r.push(e[n], a);
      if (this.stack.length < 120)
        for (let n = 0; r.length < 8 && n < e.length; n += 2) {
          let a = e[n + 1];
          r.some((s, o) => o & 1 && s == a) || r.push(e[n], a);
        }
      e = r;
    }
    let t = [];
    for (let r = 0; r < e.length && t.length < 4; r += 2) {
      let n = e[r + 1];
      if (n == this.state)
        continue;
      let a = this.split();
      a.pushState(n, this.pos), a.storeNode(0, a.pos, a.pos, 4, !0), a.shiftContext(e[r], this.pos), a.reducePos = this.pos, a.score -= 200, t.push(a);
    }
    return t;
  }
  ...
  */
  forceReduce() {
    ...
    if (!O.validAction(this.state, e)) {
      let t = e >> 19, r = e & 65535, n = this.stack.length - t * 3;
      if (n < 0 || O.getGoto(this.stack[n], r, !1) < 0) {
  ...
  */
  findForcedReduction() {
    let { parser: O } = this.p, e = [], t = (r, n) => {
      if (!e.includes(r))
        return e.push(r), O.allActions(r, (a) => {
          if (!(a & 393216)) if (a & 65536) {
            let s = (a >> 19) - n;
            if (s > 1) {
              let o = a & 65535, X = this.stack.length - s * 3;
              if (X >= 0 && O.getGoto(this.stack[X], o, !1) >= 0)
                return s << 19 | 65536 | o;
            }
          } else {
            let s = t(a, n + 1);
  ...
  */
  ...
  updateContext(O) {
    if (O != this.curContext.context) {
      let e = new me(this.curContext.tracker, O);
...
function jO(i, O = Uint16Array) {
  if (typeof i != "string")
    return i;
  let e = null;
  for (let t = 0, r = 0; t < i.length; ) {
    let n = 0;
    for (; ; ) {
      let a = i.charCodeAt(t++), s = !1;
      if (a == 126) {
        n = 65535;
        break;
      }
...
class $t {
  ...
  */
  constructor(O, e) {
    this.input = O, this.ranges = e, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = ke, this.rangeIndex = 0, this.pos = this.chunkPos = e[0].from, this.range = e[0], this.end = e[e.length - 1].to, this.readNext();
  }
  /**
  @internal
  */
  resolveOffset(O, e) {
    let t = this.range, r = this.rangeIndex, n = this.pos + O;
    for (; n < t.from; ) {
      if (!r)
        return null;
      let a = this.ranges[--r];
  ...
  peek(O) {
    ...
    if (e >= 0 && e < this.chunk.length)
      ...
      if (t = n, t >= this.chunk2Pos && t < this.chunk2Pos + this.chunk2.length)
        ...
        for (; s.to <= t; )
          s = this.ranges[++a];
        this.chunk2 = this.input.chunk(this.chunk2Pos = t), t + this.chunk2.length > s.to && (this.chunk2 = this.chunk2.slice(0, s.to - t)), r = this.chunk2.charCodeAt(0);
      }
    }
  ...
  */
  reset(O, e) {
    if (e ? (this.token = e, e.start = O, e.lookAhead = O + 1, e.value = e.extended = -1) : this.token = ke, this.pos != O) {
  ...
  */
  read(O, e) {
    ...
    for (let r of this.ranges) {
      if (r.from >= e)
        break;
      r.to > O && (t += this.input.read(Math.max(r.from, O), Math.min(r.to, e)));
    }
    return t;
  }
}
class $O {
  ...
  token(O, e) {
    let { parser: t } = e.p;
    dt(this.data, O, e, this.id, t.data, t.tokenPrecTable);
  }
}
$O.prototype.contextual = $O.prototype.fallback = $O.prototype.extend = !1;
$O.prototype.fallback = $O.prototype.extend = !1;
class A {
  /**
...
function dt(i, O, e, t, r, n) {
  let a = 0, s = 1 << t, { dialect: o } = e.p.parser;
  O: for (; s & i[a]; ) {
    let X = i[a + 1];
    for (let f = a + 3; f < X; f += 2)
      if ((i[f + 1] & s) > 0) {
        let g = i[f];
        if (o.allows(g) && (O.token.value == -1 || O.token.value == g || xt(g, O.token.value, r, n))) {
          O.acceptToken(g);
          break;
        }
      }
    let c = O.next, l = 0, Q = i[a + 2];
    if (O.next < 0 && Q > l && i[X + Q * 3 - 3] == 65535) {
      a = i[X + Q * 3 - 1];
      continue O;
    }
    for (; l < Q; ) {
      let f = l + Q >> 1, g = X + f + (f << 1), x = i[g], j = i[g + 1] || 65536;
      if (c < x)
        Q = f;
      else if (c >= j)
        l = f + 1;
...
function xt(i, O, e, t) {
  let r = Se(e, t, O);
  return r < 0 || Se(e, t, i) < r;
}
const z = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG);
let MO = null;
function ve(i, O, e) {
  let t = i.cursor(Y.IncludeAnonymous);
  for (t.moveTo(O); ; )
...
class mt {
  ...
  nextFragment() {
    ...
    if (O) {
      for (this.safeFrom = O.openStart ? ve(O.tree, O.from + O.offset, 1) - O.offset : O.from, this.safeTo = O.openEnd ? ve(O.tree, O.to + O.offset, -1) - O.offset : O.to; this.trees.length; )
  ...
  nodeAt(O) {
    ...
    for (; ; ) {
      ...
      let t = this.trees[e], r = this.index[e];
      if (r == t.children.length) {
        this.trees.pop(), this.start.pop(), this.index.pop();
        continue;
      }
      let n = t.children[r], a = this.start[e] + t.positions[r];
      if (a > O)
...
class kt {
  ...
  getActions(O) {
    let e = 0, t = null, { parser: r } = O.p, { tokenizers: n } = r, a = r.stateSlot(
      O.state,
      3
      /* ParseState.TokenizerMask */
    ), s = O.curContext ? O.curContext.hash : 0, o = 0;
    for (let X = 0; X < n.length; X++) {
      if (!(1 << X & a))
        continue;
      let c = n[X], l = this.tokens[X];
      if (!(t && !c.fallback) && ((c.contextual || l.start != O.pos || l.mask != a || l.context != s) && (this.updateCachedToken(l, c, O), l.mask = a, l.context = s), l.lookAhead > l.end + 25 && (o = Math.max(l.lookAhead, o)), l.value != 0)) {
        let Q = e;
        if (l.extended > -1 && (e = this.addActions(O, l.extended, l.end, e)), e = this.addActions(O, l.value, l.end, e), !c.extend && (t = l, e > Q))
          break;
      }
    }
    for (; this.actions.length > e; )
      this.actions.pop();
    return o && O.setLookAhead(o), !t && O.pos == this.stream.end && (t = new ZO(), t.value = O.p.parser.eofTerm, t.start = t.end = O.pos, e = this.addActions(O, t.value, t.end, e)), this.mainToken = t, this.actions;
  }
  getMainToken(O) {
    if (this.mainToken)
      return this.mainToken;
    let e = new ZO(), { pos: t, p: r } = O;
    return e.start = t, e.end = Math.min(t + 1, r.stream.end), e.value = t == r.stream.end ? r.parser.eofTerm : 0, e;
  }
  updateCachedToken(O, e, t) {
    ...
    if (e.token(this.stream.reset(r, O), t), O.value > -1) {
      ...
      O.value = 0, O.end = this.stream.clipPos(r + 1);
  }
  putAction(O, e, t, r) {
    for (let n = 0; n < r; n += 3)
      if (this.actions[n] == O)
        return r;
    return this.actions[r++] = O, this.actions[r++] = e, this.actions[r++] = t, r;
  }
  addActions(O, e, t, r) {
    let { state: n } = O, { parser: a } = O.p, { data: s } = a;
    for (let o = 0; o < 2; o++)
      for (let X = a.stateSlot(
        n,
        o ? 2 : 1
        /* ParseState.Actions */
      ); ; X += 3) {
        if (s[X] == 65535)
          if (s[X + 1] == 1)
            ...
            r == 0 && s[X + 1] == 2 && (r = this.putAction(J(s, X + 2), e, t, r));
            break;
          }
        s[X] == e && (r = this.putAction(J(s, X + 1), e, t, r));
      }
    return r;
  }
}
class St {
  constructor(O, e, t, r) {
    this.parser = O, this.input = e, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new $t(e, r), this.tokens = new kt(O, this.stream), this.topTerm = O.top[1];
    let { from: n } = r[0];
    this.stacks = [EO.start(this, O.top[0], n)], this.fragments = t.length && this.stream.end - n > O.bufferLength * 4 ? new mt(t, O.nodeSet) : null;
  }
  get parsedPos() {
  ...
  // not, it returns `null`.
  advance() {
    let O = this.stacks, e = this.minStackPos, t = this.stacks = [], r, n;
    ...
    if (!t.length) {
      let a = r && Pt(r);
      if (a)
        return z && console.log("Finish with " + this.stackID(a)), this.stackToTree(a);
      if (this.parser.strict)
        throw z && r && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), new SyntaxError("No parse at " + e);
      this.recovering || (this.recovering = 5);
    }
    if (this.recovering && r) {
      let a = this.stoppedAt != null && r[0].pos > this.stoppedAt ? r[0] : this.runRecovery(r, n, t);
      if (a)
        return z && console.log("Force-finish " + this.stackID(a)), this.stackToTree(a.forceAll());
    }
    if (this.recovering) {
      let a = this.recovering == 1 ? 1 : this.recovering * 3;
      if (t.length > a)
        for (t.sort((s, o) => o.score - s.score); t.length > a; )
          t.pop();
      ...
      O: for (let a = 0; a < t.length - 1; a++) {
        ...
        for (let o = a + 1; o < t.length; o++) {
          let X = t[o];
          if (s.sameState(X) || s.buffer.length > 500 && X.buffer.length > 500)
            if ((s.score - X.score || s.buffer.length - X.buffer.length) > 0)
              t.splice(o--, 1);
            else {
              t.splice(a--, 1);
              continue O;
  ...
  advanceStack(O, e, t) {
    let r = O.pos, { parser: n } = this, a = z ? this.stackID(O) + " -> " : "";
    if (this.stoppedAt != null && r > this.stoppedAt)
      return O.forceReduce() ? O : null;
    if (this.fragments) {
      let X = O.curContext && O.curContext.tracker.strict, c = X ? O.curContext.hash : 0;
      for (let l = this.fragments.nodeAt(r); l; ) {
        let Q = this.parser.nodeSet.types[l.type.id] == l.type ? n.getGoto(O.state, l.type.id) : -1;
        if (Q > -1 && l.length && (!X || (l.prop(P.contextHash) || 0) == c))
          return O.useNode(l, Q), z && console.log(a + this.stackID(O) + ` (via reuse of ${n.getName(l.type.id)})`), !0;
        if (!(l instanceof Z) || l.children.length == 0 || l.positions[0] > 0)
          break;
        let f = l.children[0];
        if (f instanceof Z && l.positions[0] == 0)
          l = f;
        else
          break;
      }
    ...
    if (s > 0)
      return O.reduce(s), z && console.log(a + this.stackID(O) + ` (via always-reduce ${n.getName(
        s & 65535
        /* Action.ValueMask */
      )})`), !0;
    ...
    for (let X = 0; X < o.length; ) {
      let c = o[X++], l = o[X++], Q = o[X++], f = X == o.length || !t, g = f ? O : O.split(), x = this.tokens.mainToken;
      if (g.apply(c, l, x ? x.start : g.pos, Q), z && console.log(a + this.stackID(g) + ` (via ${c & 65536 ? `reduce of ${n.getName(
        c & 65535
        /* Action.ValueMask */
      )}` : "shift"} for ${n.getName(l)} @ ${r}${g == O ? "" : ", split"})`), f)
        return !0;
      g.pos > r ? e.push(g) : t.push(g);
    }
    return !1;
  }
  ...
  runRecovery(O, e, t) {
    let r = null, n = !1;
    for (let a = 0; a < O.length; a++) {
      let s = O[a], o = e[a << 1], X = e[(a << 1) + 1], c = z ? this.stackID(s) + " -> " : "";
      if (s.deadEnd && (n || (n = !0, s.restart(), z && console.log(c + this.stackID(s) + " (restarted)"), this.advanceFully(s, t))))
        continue;
      let l = s.split(), Q = c;
      for (let f = 0; f < 10 && l.forceReduce() && (z && console.log(Q + this.stackID(l) + " (via force-reduce)"), !this.advanceFully(l, t)); f++)
        z && (Q = this.stackID(l) + " -> ");
      for (let f of s.recoverByInsert(o))
        z && console.log(c + this.stackID(f) + " (via recover-insert)"), this.advanceFully(f, t);
      this.stream.end > s.pos ? (X == s.pos && (X++, o = 0), s.recoverByDelete(o, X), z && console.log(c + this.stackID(s) + ` (via recover-delete ${this.parser.getName(o)})`), Pe(s, t)) : (!r || r.score < l.score) && (r = l);
    }
    return r;
  }
...
function Pe(i, O) {
  for (let e = 0; e < O.length; e++) {
    let t = O[e];
    if (t.pos == i.pos && t.sameState(i)) {
      O[e].score < i.score && (O[e] = i);
      return;
    }
  }
  O.push(i);
  ...
  */
  constructor(O) {
    ...
    for (let s = 0; s < O.repeatNodeCount; s++)
      e.push("");
    let t = Object.keys(O.topRules).map((s) => O.topRules[s][1]), r = [];
    for (let s = 0; s < e.length; s++)
      r.push([]);
    function n(s, o, X) {
      r[s].push([o, o.deserialize(String(X))]);
    }
    if (O.nodeProps)
      for (let s of O.nodeProps) {
        let o = s[0];
        typeof o == "string" && (o = P[o]);
        for (let X = 1; X < s.length; ) {
          let c = s[X++];
          if (c >= 0)
            n(c, o, s[X++]);
          else {
    ...
    this.nodeSet = new oe(e.map((s, o) => I.define({
    ...
    this.specializers = this.specializerSpecs.map(be), this.states = jO(O.states, Uint32Array), this.data = jO(O.stateData), this.goto = jO(O.goto), this.maxTerm = O.maxTerm, this.tokenizers = O.tokenizers.map((s) => typeof s == "number" ? new $O(a, s) : s), this.topRules = O.topRules, this.dialects = O.dialects || {}, this.dynamicPrecedences = O.dynamicPrecedences || null, this.tokenPrecTable = O.tokenPrec, this.termNames = O.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
  }
  createParse(O, e, t) {
    let r = new St(this, O, e, t);
  ...
  */
  getGoto(O, e, t = !1) {
    ...
    if (e >= r[0])
      return -1;
    for (let n = r[e + 1]; ; ) {
      let a = r[n++], s = a & 1, o = r[n++];
      if (s && t)
        return o;
      for (let X = n + (a >> 1); n < X; n++)
        if (r[n] == O)
          return o;
      if (s)
        return -1;
  ...
  */
  nextStates(O) {
    ...
    for (let t = this.stateSlot(
      ...
      if (!(this.data[t + 2] & 1)) {
        let r = this.data[t + 1];
        e.some((n, a) => a & 1 && n == r) || e.push(this.data[t], r);
      }
    }
    return e;
  }
  ...
  */
  configure(O) {
    ...
    return O.tokenizers && (e.tokenizers = this.tokenizers.map((t) => {
      let r = O.tokenizers.find((n) => n.from == t);
      return r ? r.to : t;
    })), O.specializers && (e.specializers = this.specializers.slice(), e.specializerSpecs = this.specializerSpecs.map((t, r) => {
      let n = O.specializers.find((s) => s.from == t.external);
      if (!n)
        return t;
      let a = Object.assign(Object.assign({}, t), { external: n.to });
      return e.specializers[r] = be(a), a;
...
class E {
  ...
  */
  constructor(O, e, t, r) {
    this.name = O, this.set = e, this.base = t, this.modified = r, this.id = bt++;
  }
  toString() {
    let { name: O } = this;
  ...
  static define(O, e) {
    ...
    if (O instanceof E && (e = O), e != null && e.base)
  ...
  */
  static defineModifier(O) {
    let e = new AO(O);
    return (t) => t.modified.indexOf(e) > -1 ? t : AO.get(t.base || t, t.modified.concat(e).sort((r, n) => r.id - n.id));
  }
}
let qt = 0;
class AO {
  constructor(O) {
    this.name = O, this.instances = [], this.id = qt++;
  }
  static get(O, e) {
    if (!e.length)
      return O;
    let t = e[0].instances.find((s) => s.base == O && yt(e, s.modified));
    if (t)
      return t;
    let r = [], n = new E(O.name, r, O, e);
    for (let s of e)
      s.instances.push(n);
    let a = Tt(e);
    for (let s of O.set)
...
function yt(i, O) {
  return i.length == O.length && i.every((e, t) => e == O[t]);
}
function Tt(i) {
  let O = [[]];
  for (let e = 0; e < i.length; e++)
    for (let t = 0, r = O.length; t < r; t++)
      O.push(O[t].concat(i[e]));
    ...
    for (let r of e.split(" "))
      if (r) {
        ...
        for (let l = 0; ; ) {
          ...
          if (n.push(Q[0] == "*" ? "" : Q[0][0] == '"' ? JSON.parse(Q[0]) : Q[0]), l += Q[0].length, l == r.length)
            break;
          let f = r[l++];
          if (l == r.length && f == "!") {
            a = 0;
        ...
        let o = n.length - 1, X = n[o];
        if (!X)
          throw new RangeError("Invalid path: " + r);
        let c = new yO(t, a, o > 0 ? n.slice(0, o) : null);
        O[X] = c.sort(O[X]);
      }
  }
  return Ie.add(O);
...
const Ie = new P({
  combine(i, O) {
    let e, t, r;
    for (; i || O; ) {
      if (!i || O && i.depth >= O.depth ? (r = O, O = O.next) : (r = i, i = i.next), e && e.mode == r.mode && !r.context && !e.context)
        continue;
      let n = new yO(r.tags, r.mode, r.context);
      e ? e.next = n : t = n, e = n;
    }
    return t;
  }
...
function Yt(i, O, e, t = 0, r = i.length) {
  let n = new jt(t, Array.isArray(O) ? O : [O], e);
  n.highlightRange(i.cursor(), t, r, "", n.highlighters), n.flush(r);
}
class jt {
  constructor(O, e, t) {
  ...
  highlightRange(O, e, t, r, n) {
    let { type: a, from: s, to: o } = O;
    if (s >= t || o <= e)
      return;
    a.isTop && (n = this.highlighters.filter((f) => !f.scope || f.scope(a)));
    let X = r, c = Ut(O) || yO.empty, l = _t(n, c.tags);
    if (l && (X && (X += " "), X += l, c.mode == 1 && (r += (r ? " " : "") + l)), this.startSpan(Math.max(e, s), X), c.opaque)
      return;
    let Q = O.tree && O.tree.prop(P.mounted);
    if (Q && Q.overlay) {
      let f = O.node.enter(Q.overlay[0].from + s, 1), g = this.highlighters.filter((j) => !j.scope || j.scope(Q.tree.type)), x = O.firstChild();
      for (let j = 0, w = s; ; j++) {
        let V = j < Q.overlay.length ? Q.overlay[j] : null, T = V ? V.from + s : o, N = Math.max(e, w), S = Math.min(t, T);
        if (N < S && x)
          for (; O.from < S && (this.highlightRange(O, N, S, r, n), this.startSpan(Math.min(S, O.to), X), !(O.to >= T || !O.nextSibling())); )
            ;
        if (!V || T > t)
          break;
        w = V.to + s, w > e && (this.highlightRange(f.cursor(), Math.max(e, V.from + s), Math.min(t, w), "", g), this.startSpan(Math.min(t, w), X));
      }
      x && O.parent();
      ...
      do
        if (!(O.to <= e)) {
          if (O.from >= t)
            break;
          this.highlightRange(O, e, t, r, n), this.startSpan(Math.min(t, O.to), X);
        }
      while (O.nextSibling());
      O.parent();
    }
...
function Ut(i) {
  let O = i.type.prop(Ie);
  for (; O && O.context && !i.matchContext(O.context); )
    O = O.next;
  return O || null;
}
const u = E.define, UO = u(), iO = u(), qe = u(iO), ye = u(iO), rO = u(), wO = u(rO), HO = u(rO), M = u(), uO = u(M), D = u(), B = u(), ee = u(), kO = u(ee), VO = u(), h = {
  /**
  A comment.
  */
  comment: UO,
...
const wt = 189, Vt = 190, Rt = 191, Te = 192, We = 193, _e = 194, Ye = 195, je = 1, Ue = 2, we = 196, Zt = 197, zt = 198, Ct = 3, Gt = 4, Et = 5, Lt = 6, It = 7, At = 8, Nt = 9, Ft = 10, Dt = 11, Bt = 12, Mt = 13, Ht = 14, Kt = 15, Jt = 16, Oi = 17, ei = 18, ti = 19, ii = 20, ri = 21, ni = 22, ai = 23, si = 199, oi = 200, Ne = 9, FO = 10, ue = 13, Fe = 32, DO = 33, SO = 34, ce = 35, li = 37, zO = 38, vO = 39, De = 40, te = 41, ie = 42, dO = 43, hi = 44, sO = 45, fO = 46, H = 47, Be = 48, Me = 57, OO = 58, He = 59, CO = 60, tO = 61, R = 62, Qe = 63, Ke = 64, Xi = 65, ui = 90, Je = 91, NO = 92, re = 93, GO = 94, Ot = 97, KO = 99, gO = 100, ne = 101, ci = 104, ae = 105, Qi = 108, fi = 109, cO = 110, oO = 111, pi = 112, gi = 114, fe = 116, $i = 117, di = 119, xi = 121, mi = 122, et = 123, QO = 124, se = 125, PO = 126, ki = [
  {
    token: Gt,
    supportsInterpol: !0,
    endDelimiter: vO,
  ...
  const e = ki.find((t) => O.canShift(t.token));
  vi(i, e) && i.acceptToken(e.token);
});
function vi(i, O) {
  ...
  for (let t = !1; ; t = !0) {
    let r = !1;
    if (rt(i.next))
      for (i.advance(), t = !0, r = !0; C(i.next); )
        i.advance();
    if (i.next === O.endDelimiter) {
      let n = 1;
      for (; n < O.delimiterLength && i.peek(n) === O.endDelimiter; )
        n++;
      if (n === O.delimiterLength && (!e || r))
        return t;
      i.advance(n);
    } else {
      if (i.next === ce) {
        if (O.supportsInterpol && i.peek(1) === et)
          return t;
      } else if (i.next === NO) {
        if (!(e && i.peek(1) === FO)) {
          if (O.supportsInterpol || i.peek(1) === O.endDelimiter)
            return t;
        }
      } else if (i.next === -1)
        return t;
...
const Pi = new A((i, O) => {
  let e = 0;
  for (; Ot <= i.next && i.next <= mi || Xi <= i.next && i.next <= ui || Be <= i.next && i.next <= Me; )
    i.advance(), e++;
  e > 0 && i.acceptToken(ai);
}), bi = new A((i, O) => {
  C(i.peek(-1)) || (O.canShift(je) && i.next === De ? (i.advance(), i.acceptToken(je)) : O.canShift(Ue) && i.next === Je ? (i.advance(), i.acceptToken(Ue)) : O.canShift(we) && i.next === OO && (i.advance(), C(i.next) && i.acceptToken(we)));
}), qi = new A((i, O) => {
  if (TO(i.next)) {
    for (i.advance(); TO(i.next); )
      i.advance();
    if (i.next === dO) {
      const e = i.peek(1);
      e !== dO && e !== OO && e !== H && !C(e) && i.acceptToken(Te);
    } else if (i.next === sO) {
      const e = i.peek(1);
      e !== sO && e !== R && e !== OO && e !== H && !C(e) && i.acceptToken(Te);
    }
  }
}), tt = /[\p{ID_Start}_]/u, it = /[\p{ID_Continue}@]/u, yi = new A((i, O) => {
  if (i.next === OO) {
    i.advance();
    let [e, t] = xO(i);
    if (tt.test(e)) {
      do
        i.advance(t), [e, t] = xO(i);
      while (it.test(e));
      (i.next === Qe || i.next === DO) && i.advance(), i.acceptToken(Zt);
    }
  }
}), Ti = new A((i, O) => {
  let [e, t] = xO(i);
  if (tt.test(e)) {
    do
      i.advance(t), [e, t] = xO(i);
    while (it.test(e));
    (i.next === Qe || i.next === DO) && i.advance(), i.next === OO && (i.advance(), C(i.next) && i.acceptToken(zt));
  }
}), Wi = /[_\p{Ll}\p{Lm}\p{Lo}\p{Nl}\u1885\u1886\u2118\u212E\u309B\u309C]/u, _i = /[\p{ID_Continue}]/u, Yi = new A((i, O) => {
  let [e, t] = xO(i);
  const n = e === "_" ? oi : si;
  if (Wi.test(e)) {
    do
      i.advance(t), [e, t] = xO(i);
    while (_i.test(e));
    (i.next === Qe || i.next === DO) && i.advance(), i.acceptToken(n);
  } else i.next === fO && (i.advance(), i.next === fO && (i.advance(), i.next === fO && (i.advance(), nO(i.next) && i.acceptToken(n))));
}), ji = new A((i, O) => {
  if (i.next === cO && (i.advance(), i.next === oO && (i.advance(), i.next === fe))) {
    for (i.advance(); TO(i.next); )
      i.advance();
    i.next === ae && (i.advance(), i.next === cO && (i.advance(), nO(i.next) && i.acceptToken(wt)));
  }
}), Ui = new A((i, O) => {
  i.next === H && (i.advance(), i.next === H && (i.advance(), i.acceptToken(Vt)));
}), wi = new A((i, O) => {
  i.next === Ke && (i.advance(), (i.next === gO && i.peek(1) === oO && i.peek(2) === KO && C(i.peek(3)) || i.next === fi && i.peek(1) === oO && i.peek(2) === gO && i.peek(3) === $i && i.peek(4) === Qi && i.peek(5) === ne && i.peek(6) === gO && i.peek(7) === oO && i.peek(8) === KO && C(i.peek(9)) || i.next === fe && i.peek(1) === xi && i.peek(2) === pi && i.peek(3) === ne && i.peek(4) === gO && i.peek(5) === oO && i.peek(6) === KO && C(i.peek(7))) && i.acceptToken(Rt));
}), Vi = new A((i, O) => {
  if (i.next === ue && i.advance(), i.next === FO) {
    i.advance();
    let e = 0, t = !1;
    for (; C(i.peek(e)); )
      t = t || rt(i.peek(e)), e++;
    if (O.canShift(Ye) && i.peek(e) === gO && i.peek(e + 1) === oO && nO(i.peek(e + 2))) {
      i.acceptToken(Ye);
      return;
    }
    if (O.canShift(_e) && Ri(i, e)) {
      i.acceptToken(_e);
      return;
    }
    O.canShift(We) && i.peek(e) !== He && i.peek(e) !== ce && !t && i.acceptToken(We);
  }
});
function Ri(i, O = 0) {
  if (i.peek(O) === zO) {
    if (O++, i.peek(O) === zO)
      return O++, i.peek(O) === zO, d(i, O);
  } else {
    if (i.peek(O) === tO)
      return i.peek(O) === tO ? (O++, i.peek(O) === tO && O++, d(i, O)) : i.peek(O) === PO ? (O++, d(i, O)) : (i.peek(1) === R && O++, d(i, O));
    if (i.peek(O) === OO) {
      if (O++, i.peek(O) === OO)
        return O++, i.peek(O) === OO ? !1 : d(i, O);
    } else if (i.peek(O) === dO) {
      if (O++, i.peek(O) === dO)
        return O++, i.peek(O) === dO && O++, d(i, O);
    } else if (i.peek(O) === sO) {
      if (O++, i.peek(O) === sO)
        return O++, i.peek(O) === sO && O++, d(i, O);
      if (i.peek(O) === R)
        return O++, d(i, O);
    } else if (i.peek(O) === CO) {
      if (O++, i.peek(O) === tO || i.peek(O) === sO || i.peek(O) === R)
        return O++, d(i, O);
      if (i.peek(O) === PO)
        return O++, i.peek(O) === R && O++, d(i, O);
      if (i.peek(O) === QO) {
        if (O++, i.peek(O) === R)
          return O++, d(i, O);
      } else if (i.peek(O) === CO) {
        if (O++, i.peek(O) === CO || i.peek(O) === PO)
          return O++, d(i, O);
      } else
        return d(i, O);
    } else if (i.peek(O) === R) {
      ...
      if (O++, i.peek(O) === GO && (O++, i.peek(O) === GO))
        return O++, d(i, O);
    } else if (i.peek(O) === DO) {
      if (O++, i.peek(O) === tO)
        return O++, i.peek(O) === tO && O++, d(i, O);
    } else if (i.peek(O) === PO) {
      if (O++, i.peek(O) === R)
        return O++, i.peek(O) === R && O++, d(i, O);
    } else {
      if (i.peek(O) === QO)
        return O++, i.peek(O) === QO ? (O++, i.peek(O) === QO && O++, d(i, O)) : (i.peek(O) === R && O++, d(i, O));
      if (i.peek(O) === ie)
        return O++, i.peek(O) === ie && O++, d(i, O);
      if (i.peek(O) === H)
        return O++, i.peek(O) === H && O++, d(i, O);
      if (i.peek(O) === fO)
        return O++, i.peek(O) === fO ? (O++, i.peek(O) === fO ? !1 : d(i, O)) : d(i, O);
      if (i.peek(O) === NO) {
        if (O++, i.peek(O) === NO)
          return O++, d(i, O);
      } else if (i.peek(O) === di) {
        if (O++, i.peek(O) === ci && (O++, i.peek(O) === ne && (O++, i.peek(O) === cO)))
          return O++, nO(i.peek(O)) && d(i, O);
      } else if (i.peek(O) === Ot) {
        if (O++, i.peek(O) === cO && (O++, i.peek(O) === gO))
          return O++, nO(i.peek(O)) && d(i, O);
      } else if (i.peek(O) === oO) {
        if (O++, i.peek(O) === gi)
          return O++, nO(i.peek(O)) && d(i, O);
        ...
        if (O++, i.peek(O) === cO)
          return O++, nO(i.peek(O)) && d(i, O);
      } else if (i.peek(O) === cO && (O++, i.peek(O) === oO && (O++, i.peek(O) === fe))) {
        for (O++; TO(i.peek(O)); )
          O++;
        if (i.peek(O) === ae && (O++, i.peek(O) === cO))
          return O++, nO(i.peek(O)) && d(i, O);
      }
    }
  }
...
const Ci = Wt({
  ...
  tokenizers: [ji, Ui, wi, qi, Vi, bi, yi, Ti, Si, Pi, Yi, 0, 1, 2],
  topRules: { Source: [0, 25] },
  dynamicPrecedences: { 43: 1, 79: -1, 150: -1 },
  specialized: [{ term: 199, get: (i) => Gi[i] || -1 }, { term: 200, get: (i) => Ei[i] || -1 }],
  tokenPrec: 42923
});
function Ii(i) {
  return Li.parse(i);
...
function Ni(i, O) {
  const e = [];
  return Yt(O, Ai, (t, r, n) => {
    e.push({ from: t, to: r, classes: n });
  }), e;
}
function Ve(i, O, e) {
  const t = [];
  for (const r of i)
    r.to <= O || r.from >= e || t.push({
      from: Math.max(r.from, O) - O,
      to: Math.min(r.to, e) - O,
      classes: r.classes
    });
  return t;
}
...
function nt(i, O, e, t) {
  const r = Fi[i.type.name];
  if (r) {
    const a = Re(e, i.from), s = Re(e, i.to - 1);
    if (s > a) {
      let o = r.open, X = i.from;
      if (i.type.name === "String" || i.type.name === "Charlist") {
        const c = O.slice(i.from, Math.min(i.from + 3, i.to));
        c === '"""' || c === "'''" ? o = c : o = c[0] || r.open;
      }
      t.push({
        startLine: a,
        endLine: s,
  ...
  let n = i.firstChild;
  for (; n; )
    nt(n, O, e, t), n = n.nextSibling;
}
function Bi(i, O) {
  const e = Di(i), t = [];
  return nt(O.topNode, i, e, t), t.sort((r, n) => r.startLine - n.startLine || r.startOffset - n.startOffset), t;
}
function Mi(i) {
...
class Hi {
  constructor() {
    ...
    k(this, "foldedLines", /* @__PURE__ */ new Set());
    /** Map from startLine to FoldRegion */
    k(this, "regionMap", /* @__PURE__ */ new Map());
...
class Ki {
  ...
  search(O, e, t) {
    ...
    for (let n = 0; n < O.length; n++) {
      ...
      let s = 0;
      for (; s <= a.length - r.length; ) {
        const o = a.indexOf(r, s);
        if (o === -1) break;
        this.matches.push({
          line: n,
          from: o,
...
const Ze = /* @__PURE__ */ new Set(["Map", "List", "Tuple", "Bitstring"]), Ji = /* @__PURE__ */ new Set(["{", "}", "[", "]", "<<", ">>"]), ze = /* @__PURE__ */ new Set([
  "String",
  "Atom",
  "Alias",
  "Integer",
...
function er(i, O, e) {
  ...
  const t = i.resolveInner(e, 1);
  return t ? tr(t, O) : null;
}
function tr(i, O) {
  const e = i.type.name;
  if (Ji.has(e)) {
    const r = i.parent;
    if (r && Ze.has(r.type.name))
      return {
        from: r.from,
        to: r.to,
...
function at(i, O) {
  if (i.type.name !== "BinaryOperator") return !1;
  let e = i.firstChild;
  for (; e; ) {
...
function Ce(i, O) {
  if (i.type.name !== "BinaryOperator") return !1;
  let e = !1, t = !1, r = i.firstChild;
  for (; r; )
    r.type.name === "Operator" && O.slice(r.from, r.to) === "//" && (e = !0), at(r, O) && (t = !0), r = r.nextSibling;
  return e && t;
}
function ir(i, O) {
  let e = i;
...
class sr {
  constructor(O, e) {
    ...
    k(this, "innerEl");
    k(this, "scrollEl");
    k(this, "toolbarEl", null);
    k(this, "wrapBtn", null);
    k(this, "copyBtn", null);
    k(this, "searchBtn", null);
    k(this, "copyResetTimer", null);
    k(this, "code", "");
    k(this, "lines", []);
    k(this, "lineOffsets", []);
    k(this, "tokens", []);
    k(this, "tree", null);
    k(this, "foldState", new Hi());
    k(this, "searchState", new Ki());
    k(this, "onRenderCallback", null);
    k(this, "wordWrap", !1);
    k(this, "toolbarConfig");
    // Search UI elements
    k(this, "searchBarEl", null);
    k(this, "searchInputEl", null);
    k(this, "searchInfoEl", null);
    k(this, "searchCaseBtn", null);
    k(this, "searchVisible", !1);
    // Inspect state
    k(this, "currentInspect", null);
    k(this, "inspectCallback", null);
    // Pre-processed inspect literals (#Reference<...>, #PID<...>, etc.)
    k(this, "inspectLiterals", []);
    this.container = O, this.container.classList.add("edv-container");
    ...
    this.toolbarConfig = {
      ...
      copy: t.copy !== !1,
      search: t.search !== !1
    }, this.buildToolbar(), this.buildSearchBar(), this.innerEl = document.createElement("div"), this.innerEl.classList.add("edv-inner"), this.container.appendChild(this.innerEl), this.scrollEl = document.createElement("div"), this.scrollEl.classList.add("edv-scroll"), this.innerEl.appendChild(this.scrollEl), this.scrollEl.addEventListener("mouseover", (r) => this.handleInspectHover(r)), this.scrollEl.addEventListener("mouseout", (r) => this.handleInspectOut(r)), this.scrollEl.addEventListener("click", (r) => this.handleInspectClick(r)), this.container.setAttribute("tabindex", "0"), this.container.addEventListener("keydown", (r) => this.handleKeyDown(r));
  }
  /**
  ...
  buildToolbar() {
    ...
    if (O.foldAll || O.unfoldAll || O.wordWrap || O.copy || O.search) {
      if (this.toolbarEl = document.createElement("div"), this.toolbarEl.classList.add("edv-toolbar"), O.search && (this.searchBtn = this.createToolbarButton(
        ...
        "Search (Ctrl+F)",
        () => this.toggleSearch()
      ), this.toolbarEl.appendChild(this.searchBtn)), O.foldAll) {
  ...
  buildSearchBar() {
    ...
    r.classList.add("edv-search-nav-btn"), r.textContent = "✕", r.title = "Close (Escape)", r.addEventListener("click", (n) => {
      n.stopPropagation(), this.closeSearch();
    }), this.searchBarEl.appendChild(r), this.container.appendChild(this.searchBarEl);
  }
  /**
  ...
  createToolbarButton(O, e, t) {
    const r = document.createElement("button");
    return r.classList.add("edv-toolbar-btn"), r.textContent = O, r.title = e, r.addEventListener("click", (n) => {
      n.stopPropagation(), t();
    }), r;
  }
  /**
  ...
  toggleCaseSensitive() {
    ...
    (r = this.searchCaseBtn) == null || r.classList.toggle("edv-search-case-btn--active", O);
...
`), this.buildLineOffsets();
    const { modifiedCode: e, inspectLiterals: t } = nr(O);
    this.inspectLiterals = t;
    const r = Ii(e);
    this.tree = r, this.tokens = Ni(e, r), this.fixInspectLiteralTokenClasses();
    const n = Bi(e, r), a = Mi(n);
    this.foldState.setRegions(n, a), this.searchState.isActive() && (this.searchState.search(
      this.lines,
...
` && this.lineOffsets.push(O + 1);
  ...
  render() {
    ...
    for (; t < O; ) {
      ...
      const a = this.foldState.isFoldable(t), s = this.foldState.isFolded(t), o = this.foldState.getRegion(t), X = this.createLineElement(
        t,
        e,
        a,
        s,
      ...
      this.scrollEl.appendChild(X), t++;
    }
    (r = this.onRenderCallback) == null || r.call(this), this.searchState.isActive() && this.searchState.getCurrentMatch() && requestAnimationFrame(() => this.scrollToCurrentMatch());
  }
  /**
   * Create a single line element with gutter and code content.
   */
  createLineElement(O, e, t, r, n) {
    ...
    const o = document.createElement("div");
    o.classList.add("edv-gutter");
    const X = document.createElement("span");
    X.classList.add("edv-line-number"), X.textContent = String(O + 1).padStart(e, " "), o.appendChild(X);
    const c = document.createElement("span");
    c.classList.add("edv-fold-indicator"), t && (c.classList.add("edv-foldable"), c.textContent = r ? "▶" : "▼", c.addEventListener("click", (Q) => {
      Q.stopPropagation(), this.foldState.toggle(O), this.render();
    })), o.appendChild(c), a.appendChild(o);
    const l = document.createElement("div");
    return l.classList.add("edv-code"), r && n ? this.renderFoldedLine(l, O, n) : this.renderHighlightedLine(l, O), a.appendChild(l), a;
  }
  /**
   * Render a normal highlighted line, with search match highlighting.
   */
  renderHighlightedLine(O, e) {
    const t = this.lines[e], r = this.lineOffsets[e], n = r + t.length, a = Ve(this.tokens, r, n), s = this.searchState.getLineMatches(e);
    if (t.length === 0) {
      O.innerHTML = "&nbsp;";
      return;
    }
    if (s.length === 0) {
      this.renderTokenizedText(O, t, a, r);
      return;
    }
    this.renderWithSearchHighlights(O, t, a, s, e);
  }
  /**
   * Render tokenized text without search highlights.
   */
  renderTokenizedText(O, e, t, r) {
    const n = r ?? 0;
    if (t.length === 0) {
    ...
    for (const s of t) {
      if (s.from > a) {
        const X = document.createElement("span");
        X.dataset.from = String(n + a), X.dataset.to = String(n + s.from), X.textContent = e.slice(a, s.from), O.appendChild(X);
      }
      const o = document.createElement("span");
      o.className = s.classes, o.dataset.from = String(n + s.from), o.dataset.to = String(n + s.to), o.textContent = e.slice(s.from, s.to), O.appendChild(o), a = s.to;
    }
    if (a < e.length) {
      const s = document.createElement("span");
   ...
   */
  renderWithSearchHighlights(O, e, t, r, n) {
    const a = new Array(e.length).fill(null);
    for (const l of t)
      for (let Q = l.from; Q < l.to && Q < e.length; Q++)
        a[Q] = l.classes;
    const s = [], o = new Array(e.length).fill(null);
    for (const l of r)
      for (let Q = l.from; Q < l.to && Q < e.length; Q++)
        o[Q] = l;
    let X = 0;
    for (; X < e.length; ) {
      const l = a[X], Q = o[X], f = Q !== null, g = Q ? this.searchState.isCurrentMatch(n, Q.from) : !1;
      let x = X + 1;
      for (; x < e.length; ) {
        const j = a[x], w = o[x], V = w !== null, T = w ? this.searchState.isCurrentMatch(n, w.from) : !1;
        if (j !== l || V !== f || T !== g) break;
        x++;
      }
      s.push({ from: X, to: x, tokenClass: l, isMatch: f, isCurrent: g }), X = x;
    }
    const c = this.lineOffsets[n];
    for (const l of s) {
      const Q = e.slice(l.from, l.to), f = c + l.from, g = c + l.to;
      if (l.isMatch) {
        const x = document.createElement("mark");
        if (x.classList.add("edv-search-match"), l.isCurrent && x.classList.add("edv-search-current"), x.dataset.from = String(f), x.dataset.to = String(g), l.tokenClass) {
          const j = document.createElement("span");
          j.className = l.tokenClass, j.textContent = Q, x.appendChild(j);
        } else
          x.textContent = Q;
        O.appendChild(x);
      } else if (l.tokenClass) {
        const x = document.createElement("span");
        x.className = l.tokenClass, x.dataset.from = String(f), x.dataset.to = String(g), x.textContent = Q, O.appendChild(x);
      } else {
        const x = document.createElement("span");
        x.dataset.from = String(f), x.dataset.to = String(g), x.textContent = Q, O.appendChild(x);
      }
    }
  }
  /**
  ...
  renderFoldedLine(O, e, t) {
    const r = this.lines[e], n = this.lineOffsets[e], a = n + r.length, s = Ve(this.tokens, n, a);
    let o = 0;
    for (const l of s) {
      if (l.from > o) {
        const f = document.createElement("span");
        f.dataset.from = String(n + o), f.dataset.to = String(n + l.from), f.textContent = r.slice(o, l.from), O.appendChild(f);
      }
      const Q = document.createElement("span");
      Q.className = l.classes, Q.dataset.from = String(n + l.from), Q.dataset.to = String(n + l.to), Q.textContent = r.slice(l.from, l.to), O.appendChild(Q), o = l.to;
    }
    if (o < r.length) {
      const l = document.createElement("span");
      l.dataset.from = String(n + o), l.dataset.to = String(n + r.length), l.textContent = r.slice(o), O.appendChild(l);
    }
    const X = document.createElement("span");
    X.classList.add("edv-fold-ellipsis"), X.textContent = "…", X.title = `${t.endLine - t.startLine} lines folded`, X.dataset.from = String(t.startOffset), X.dataset.to = String(t.endOffset), X.addEventListener("click", (l) => {
      l.stopPropagation(), this.foldState.toggle(e), this.render();
    }), O.appendChild(X);
    const c = document.createElement("span");
    c.classList.add("tok-punctuation"), c.dataset.from = String(t.endOffset - t.closeText.length), c.dataset.to = String(t.endOffset), c.textContent = t.closeText, O.appendChild(c);
  }
  ...
  handleInspectHover(O) {
    ...
    const r = parseInt(t.dataset.from, 10);
    if (isNaN(r)) return;
    const n = er(this.tree, this.code, r);
    if (!n) {
      this.clearInspectHighlight();
      return;
    }
  ...
  applyInspectHighlight(O) {
    if (O.isStructure) {
      const e = this.offsetToLine(O.from), t = this.offsetToLine(O.to - 1), r = this.scrollEl.querySelectorAll(".edv-line");
      for (const n of r) {
  ...
  highlightSpansInRange(O, e, t) {
    const r = this.scrollEl.querySelectorAll("[data-from]");
    for (const n of r) {
  ...
  offsetToLine(O) {
    ...
    for (; e < t; ) {
      const r = e + t + 1 >> 1;
      this.lineOffsets[r] <= O ? e = r : t = r - 1;
    }
    return e;
  }
}
export {
  sr as ElixirDataViewer,
  Hi as FoldState,
  Ki as SearchState,
  Mi as buildFoldMap,
  sr as default,
  Bi as detectFoldRegions,
  Ve as getLineTokens,
  Ni as highlight,
  Ii as parseElixir,
  nr as preprocessInspectLiterals,
  er as resolveInspectTarget
};
