...
function gt(r) {
  ...
  function X(b, _, g, Y, P, j) {
    ...
    if (W - x <= i && (hO = S(s.pos - _, P))) {
      ...
      let H = s.pos - w;
      s.next();
      let G = [], D = [], XO = k >= a ? k : -1, dO = 0, _O = W;
      for (; s.pos > H; )
        XO >= 0 && s.id == XO && s.size >= 0 ? (s.end <= _O - i && (Q(G, D, x, dO, s.end, _O, XO, V, eO), dO = G.length, _O = s.end), s.next()) : j > 2500 ? c(x, H, G, D) : X(x, H, G, D, XO, j + 1);
      if (XO >= 0 && dO > 0 && dO < G.length && Q(G, D, x, dO, x, _O, XO, V, eO), G.reverse(), D.reverse(), XO > -1 && dO > 0) {
        let ge = p(mO, eO);
        WO = ce(mO, G, D, 0, G.length, 0, W - x, ge, ge);
      } else
        WO = $(mO, G, D, W - x, V - W, eO);
    }
    g.push(WO), Y.push(Qe);
  }
  function c(b, _, g, Y) {
...
class $t {
  ...
  */
  startParse(O, e, t) {
    return typeof O == "string" && (O = new xt(O)), t = t ? t.length ? t.map((i) => new MO(i.from, i.to)) : [new MO(0, 0)] : [new MO(0, O.length)], this.createParse(O, e || [], t);
  }
  /**
...
class LO {
  ...
  */
  static start(O, e, t = 0) {
    ...
    return new LO(O, [], e, t, t, 0, [], 0, i ? new ke(i, i.start) : null, 0, null);
  }
  /**
  ...
  */
  split() {
    ...
    for (; O && i == O.bufferBase; )
      O = O.parent;
    return new LO(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, t, i, this.curContext, this.lookAhead, O);
  }
...
class IO {
  ...
  static create(O, e = O.bufferBase + O.buffer.length) {
    return new IO(O, e, e - O.bufferBase);
  }
  maybeNext() {
...
class Pt {
  constructor(O, e, t, i) {
    ...
    let { from: n } = i[0];
    this.stacks = [LO.start(this, O.top[0], n)], this.fragments = t.length && this.stream.end - n > O.bufferLength * 4 ? new bt(t, O.nodeSet) : null;
  }
  get parsedPos() {
  ...
  stackID(O) {
    let e = (KO || (KO = /* @__PURE__ */ new WeakMap())).get(O);
    return e || KO.set(O, e = String.fromCodePoint(this.nextStackID++)), e + O;
  }
}
function ye(r, O) {
  for (let e = 0; e < O.length; e++) {
...
class FO extends $t {
  ...
  */
  constructor(O) {
    ...
    this.nodeSet = new oe(e.map((s, l) => F.define({
  ...
  */
  configure(O) {
    let e = Object.assign(Object.create(FO.prototype), this);
...
function Zt(r) {
  let O = r.type.prop(Ae);
  for (; O && O.context && !r.matchContext(O.context); )
    O = O.next;
  return O || null;
}
const f = L.define, jO = f(), iO = f(), Te = f(iO), qe = f(iO), rO = f(), UO = f(rO), HO = f(rO), M = f(), cO = f(M), N = f(), B = f(), te = f(), kO = f(te), VO = f(), h = {
  /**
  A comment.
  */
  comment: jO,
...
const zt = 189, Ct = 190, Et = 191, We = 192, _e = 193, we = 194, Ye = 195, je = 1, Ue = 2, Ve = 196, Gt = 197, Lt = 198, It = 3, Ft = 4, At = 5, Dt = 6, Nt = 7, Bt = 8, Mt = 9, Kt = 10, Ht = 11, Jt = 12, Oi = 13, ei = 14, ti = 15, ii = 16, ri = 17, ni = 18, ai = 19, si = 20, li = 21, oi = 22, hi = 23, Xi = 199, ci = 200, Ne = 9, NO = 10, ue = 13, Be = 32, BO = 33, vO = 34, fe = 35, ui = 37, CO = 38, SO = 39, Me = 40, ie = 41, re = 42, $O = 43, fi = 44, sO = 45, pO = 46, K = 47, Ke = 48, He = 57, OO = 58, Je = 59, EO = 60, tO = 61, R = 62, pe = 63, Ot = 64, pi = 65, di = 90, et = 91, DO = 92, ne = 93, GO = 94, tt = 97, JO = 99, QO = 100, ae = 101, Qi = 104, se = 105, gi = 108, $i = 109, uO = 110, lO = 111, xi = 112, mi = 114, de = 116, ki = 117, vi = 119, Si = 121, bi = 122, it = 123, fO = 124, le = 125, bO = 126, yi = [
  {
    token: Ft,
    supportsInterpol: !0,
    endDelimiter: SO,
...
const qi = new A((r, O) => {
...
}), rt = /[\p{ID_Start}_]/u, nt = /[\p{ID_Continue}@]/u, wi = new A((r, O) => {
  if (r.next === OO) {
    r.advance();
    let [e, t] = xO(r);
    if (rt.test(e)) {
      ...
      while (nt.test(e));
      (r.next === pe || r.next === BO) && r.advance(), r.acceptToken(Gt);
    }
  }
}), Yi = new A((r, O) => {
  let [e, t] = xO(r);
  if (rt.test(e)) {
    do
      r.advance(t), [e, t] = xO(r);
    while (nt.test(e));
    (r.next === pe || r.next === BO) && r.advance(), r.next === OO && (r.advance(), E(r.next) && r.acceptToken(Lt));
  }
}), ji = /[_\p{Ll}\p{Lm}\p{Lo}\p{Nl}\u1885\u1886\u2118\u212E\u309B\u309C]/u, Ui = /[\p{ID_Continue}]/u, Vi = new A((r, O) => {
  let [e, t] = xO(r);
  const n = e === "_" ? ci : Xi;
  if (ji.test(e)) {
    do
      r.advance(t), [e, t] = xO(r);
    while (Ui.test(e));
    (r.next === pe || r.next === BO) && r.advance(), r.acceptToken(n);
  ...
  r.next === Ot && (r.advance(), (r.next === QO && r.peek(1) === lO && r.peek(2) === JO && E(r.peek(3)) || r.next === $i && r.peek(1) === lO && r.peek(2) === QO && r.peek(3) === ki && r.peek(4) === gi && r.peek(5) === ae && r.peek(6) === QO && r.peek(7) === lO && r.peek(8) === JO && E(r.peek(9)) || r.next === de && r.peek(1) === Si && r.peek(2) === xi && r.peek(3) === ae && r.peek(4) === QO && r.peek(5) === lO && r.peek(6) === JO && E(r.peek(7))) && r.acceptToken(Et));
}), Ci = new A((r, O) => {
...
function Ei(r, O = 0) {
  if (r.peek(O) === CO) {
    ...
    if (r.peek(O) === OO) {
      ...
      if (O++, r.peek(O) === GO && (O++, r.peek(O) === GO))
        return O++, m(r, O);
    } else if (r.peek(O) === BO) {
      if (O++, r.peek(O) === tO)
...
const Ii = jt({
  ...
  specialized: [{ term: 199, get: (r) => Fi[r] || -1 }, { term: 200, get: (r) => Ai[r] || -1 }],
  tokenPrec: 42923
});
function Ni(r) {
  return Di.parse(r);
...
class dr {
  constructor(O, e) {
    ...
    d(this, "foldLevelEl", null);
    d(this, "currentFoldLevel", 0);
    // 0 = all expanded
    d(this, "wrapBtn", null);
    d(this, "copyBtn", null);
  ...
  buildToolbar() {
    ...
    if (O.foldAll || O.unfoldAll || O.foldLevel || O.wordWrap || O.copy || O.search || O.filter) {
      ...
      if (O.foldLevel) {
        ...
        t.classList.add("edv-fold-level-group");
        const i = this.createToolbarButton(
          "−",
          "Decrease Fold Level",
          () => this.decreaseFoldLevel()
        );
        t.appendChild(i), this.foldLevelEl = document.createElement("span"), this.foldLevelEl.classList.add("edv-fold-level-display"), this.foldLevelEl.title = "Current Fold Level", this.updateFoldLevelDisplay(), t.appendChild(this.foldLevelEl);
        const n = this.createToolbarButton(
          "+",
          "Increase Fold Level",
          () => this.increaseFoldLevel()
        );
        t.appendChild(n), this.toolbarEl.appendChild(t);
      }
   ...
   */
  foldAll() {
    this.foldState.foldAll(), this.currentFoldLevel = 1, this.updateFoldLevelDisplay(), this.render();
  }
  /**
   * Unfold all folded regions.
   */
  unfoldAll() {
    this.foldState.unfoldAll(), this.currentFoldLevel = 0, this.updateFoldLevelDisplay(), this.render();
  }
  /**
   ...
   */
  foldToLevel(O) {
    this.foldState.foldToLevel(O), this.currentFoldLevel = O, this.updateFoldLevelDisplay(), this.render();
  }
  /**
   ...
   */
  decreaseFoldLevel() {
    const O = this.foldState.getMaxDepth();
    O !== 0 && (this.currentFoldLevel === 0 ? this.currentFoldLevel = O : this.currentFoldLevel > 1 && this.currentFoldLevel--, this.foldState.foldToLevel(this.currentFoldLevel), this.updateFoldLevelDisplay(), this.render());
  }
  /**
  ...
  increaseFoldLevel() {
    const O = this.foldState.getMaxDepth();
    O !== 0 && this.currentFoldLevel !== 0 && (this.currentFoldLevel < O ? (this.currentFoldLevel++, this.foldState.foldToLevel(this.currentFoldLevel)) : (this.currentFoldLevel = 0, this.foldState.unfoldAll()), this.updateFoldLevelDisplay(), this.render());
  }
  /**
   * Update the fold level display element text.
   */
  updateFoldLevelDisplay() {
    this.foldLevelEl && (this.currentFoldLevel === 0 ? (this.foldLevelEl.textContent = "All", this.foldLevelEl.title = "All levels expanded") : (this.foldLevelEl.textContent = String(this.currentFoldLevel), this.foldLevelEl.title = `Fold level ${this.currentFoldLevel}: levels 1–${this.currentFoldLevel} expanded`));
  }
  /**
  ...
  revealAndScrollToMatch(O) {
    ...
    const e = this.getLongStringsForLine(O.line);
    if (e.length > 0) {
      const t = this.lineOffsets[O.line], i = t + O.from, n = t + O.to;
      for (const a of e) {
        if (this.isStringExpanded(a)) continue;
        const s = 1, o = a.from + s + RO, u = a.to - s;
        if (n > o && i < u) {
          const X = `${a.from}:${a.to}`;
          this.expandedStrings.add(X);
        }
      }
    }
  }
...
`), this.buildLineOffsets();
    ...
    this.foldState.setRegions(n, a), this.filterState.detectKeys(i, e), this.defaultFilterKeys.length > 0 && !this.filterState.isActive() && (this.filterState.setKeys(this.defaultFilterKeys), this.updateFilterTags(), this.updateFilterInfo(), this.updateFilterBtnState()), this.defaultFoldLevel > 0 ? (this.foldState.foldToLevel(this.defaultFoldLevel), this.currentFoldLevel = this.defaultFoldLevel) : this.currentFoldLevel = 0, this.updateFoldLevelDisplay(), this.searchState.isActive() && (this.searchState.search(
      this.lines,
...
` && this.lineOffsets.push(O + 1);
  ...
  createLineElement(O, e, t, i, n) {
    ...
    if (a.classList.add("edv-line"), a.dataset.line = String(O), this.searchState.getLineMatches(O).length > 0) {
      a.classList.add("edv-line--has-match");
      const c = this.searchState.getCurrentMatch();
      c && c.line === O && a.classList.add("edv-line--current-match");
    }
  ...
  applyStringTruncation(O, e) {
    ...
    if (t.length !== 0)
      for (const i of t) {
        ...
        const o = s + RO, u = Array.from(O.children);
        let X = null;
